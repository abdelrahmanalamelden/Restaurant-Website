...
mongoose
  .connect(
    'mongodb+srv://E-commerce:umSHdfKQsZFJg3eF@nasacluster.rcyj9d9.mongodb.net/',
    {
...
function transformData(mealData) {
  return {
    productName: mealData.strMeal || 'Unknown Product',
    productPrice: Math.floor(Math.random() * 100) + 1, // Random price between 1 and 100
    productCategory: 'food', // Set to 'food' based on the type of data
    productSupplier: mealData.strArea || 'Unknown Supplier',
    productQuantity: Math.floor(Math.random() * 100) + 1, // Random quantity between 1 and 100
    productImage: mealData.strMealThumb ? [mealData.strMealThumb] : [], // Array with image or empty
    productRegisteredAt: new Date(),
  };
}
...
const generate = async () => {
  try {
    ...
    console.log('Products successfully pushed to MongoDB');
  } catch (error) {
    console.error('Error fetching or pushing products:', error);
  } finally {
